...
<div id="kt_header_search" class="d-flex align-items-stretch" data-kt-search-keypress="true"
	...
	<div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
		...
		<div data-kt-search-element="wrapper">
			...
			@include('layout/search/partials/_form')


			@include('layout/search/partials/_results')


			@include('layout/search/partials/_main')


			@include('layout/search/partials/_empty')

		</div>
		<!--end::Wrapper-->

		@include('layout/search/partials/_advanced-options')


		@include('layout/search/partials/_preferences')
