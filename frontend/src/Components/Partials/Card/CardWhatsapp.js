    ...
    <div className='w-1/1 m-2 w-96 h-72 sm:w-72 flex justify-center items-center bg-white rounded-lg border-gray-200 shadow-md'>
        <div className='flex flex-col items-center'>
            ...
            <div className='flex mt-4 space-x-3 lg:mt-6'>
                <a href='#' className='inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center'>Sign Out</a>
