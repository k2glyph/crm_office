  ...
  return (
    <div className='shadow-md sm:rounded-lg border border-1'>
        <div className='p-7 flex flex-row justify-between items-center bg-white'>
            ...
            <div>
                <a href='#' className='flex flex-row text-white hover:text-blue-300 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm text-center py-2 px-3 items-center'>
            ...
            <table className='w-full text-sm text-left text-gray-500 dark:text-gray-400'>
                ...
                <tbody>
                    <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
                        ...
                        <td className='px-6 py-4'>
                            <a href='#' className='inline-block hover:text-cyan-700 text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 rounded-lg text-sm text-center px-2 py-1'>
