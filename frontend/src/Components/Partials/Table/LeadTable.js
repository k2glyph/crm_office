  ...
  return (
    <div className='shadow-md sm:rounded-lg border border-1'>
        <div className='p-7 flex flex-row justify-between items-center bg-white'>
            ...
            <div>
                <a href='#' className='flex flex-row text-white hover:text-blue-300 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm text-center py-2 px-3 items-center'>
